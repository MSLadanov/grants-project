...
const SearchBar = ({ searchGrants, handleSearchChange, clearSearchQuery, searchQuery }): ReactElement => {
  return (
    <div className="grants-searchbar">
      <div className="grants-searchbar-input">
        <img src={search} alt="" />
        <input placeholder="Введите название программы" value={searchQuery} onChange={(e) => handleSearchChange(e)} />
